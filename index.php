...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title> Property Aggregation Portal ||Home page</title>
</head>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="slider--content">
                            <div class="text-center">
                                <h1>Find the property that you want</h1>
                            </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="heading heading-2 text-center mb-70">
                            <h2 class="heading--title">POPULAR PROPERTIES</h2>
                            <p class="heading--desc"> Get the Latest property updates</p>
                        </div>
                        <!-- .heading-title end -->
                    </div>
                    <!-- .col-md-12 end -->
...
<?php echo $row['Country'];?></p>
                                    ...
                                    <div class="property--features">
                                        <ul class="list-unstyled mb-0">
                                            <li><span class="feature">Bed:</span><span class="feature-num"><?php echo $row['Bedrooms'];?></span></li>
                                            <li><span class="feature">Bath:</span><span class="feature-num"><?php echo $row['Bathrooms'];?></span></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3">
                        <h3>If you have any QUERIES or need any HELP contact us</h3>
