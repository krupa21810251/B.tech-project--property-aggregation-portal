...
<head>
    ...
    <title>Property Aggregation Portal|| Listed Properties</title>
    <!-- Bootstrap CSS -->
...
<body>
   ...
   <th>Mobile Number</th>
            ...
            <th data-breakpoints="xs">Action</th>
                                        ...
                                        <tbody>
                                          <?php
$ret=mysqli_query($con,"select tbluser.FullName,tbluser.MobileNumber,tblproperty.PropertyID,tblproperty.PropertyTitle,tblproperty.ListingDate,tblproperty.ID from tblproperty join tbluser on tbluser.ID=tblproperty.UserID");
$cnt=1;
