...
<head>
    ...
    <title>Property Aggregation Portal|| Login</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><h2 style="color: blue">PropertyAggregationPortal</h2><span class="splash-description">Please enter the required information.</span></div>
            <div class="card-body">
